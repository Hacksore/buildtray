...
import { Button, darken, Skeleton, styled, Tooltip, Typography } from "@mui/material";
...
const { NEXT_BUILDTRAY_APP_URL } = process.env;
      ...
      return (
        <>
          <Box sx={{ display: "flex", flexDirection: "row" }}>
            ...
            <a className="link" target="_blank" rel="noreferrer" href={NEXT_BUILDTRAY_APP_URL}>
